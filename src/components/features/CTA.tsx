  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-3xl mx-auto text-center bg-gradient-to-r from-accent-500/10 to-blue-500/10 border border-accent-500/20 rounded-2xl p-12">
        ...
        <Link to="/pricing" className="inline-flex items-center gap-2 bg-accent-600 hover:bg-accent-500 text-white px-8 py-3.5 rounded-xl font-semibold transition-colors">
