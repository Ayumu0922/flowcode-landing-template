  ...
  return (
    <motion.div
      ...
      className={`rounded-2xl p-8 flex flex-col ${
        highlighted
          ? 'bg-gradient-to-b from-violet-500/20 to-zinc-900/50 border-2 border-violet-500/50 ring-1 ring-violet-500/20'
    ...
    >
      ...
      <button className={`w-full py-3 rounded-xl font-semibold transition-colors ${
        highlighted ? 'bg-violet-600 hover:bg-violet-500 text-white' : 'bg-zinc-800 hover:bg-zinc-700 text-zinc-300'
      }`}>
        {cta}
      </button>
    </motion.div>
